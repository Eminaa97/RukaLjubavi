...
class ZahtjeviBenefiktoraFilterDialog(var activity: Activity) {
    ...
    fun startDialog(){
        ...
        var dialogView = inflater.inflate(R.layout.dialog_filter_zahtjevi_benefiktora,null)
    ...
    private fun load(){
        ...
        val requestCall = serviceDonacije.get(true, if(kategorijaId == -1) null else kategorijaId, txtNazivKomp?.text.toString(),if(lokacijaId == -1) null else lokacijaId,null)
