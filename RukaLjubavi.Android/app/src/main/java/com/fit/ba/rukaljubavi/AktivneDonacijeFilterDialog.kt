...
class AktivneDonacijeFilterDialog(var activity: Activity) {
    ...
    fun startDialog(){
        ...
        var dialogView = inflater.inflate(R.layout.dialog_filter_aktivne_donacije,null)
    ...
    private fun load(){
        ...
        val requestCall = serviceDonacije.get(isZahtjevZaBenefiktora = true,KategorijaId =  if(kategorijaId == -1) null else kategorijaId, LokacijaDonatorId =  if(lokacijaId == -1) null else lokacijaId)
